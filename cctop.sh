...
#
#
# cctop:  check CPU and memory usage on CCRC servers
#        usage: cctop -h
#
#
#
...
# shows instantaneous usage through mpstat 1 1 
...
#
#
# https://github.com/axogmn/cctop
# Version: 1.7
# Date 9/06/16: fixed to allow user outside servers to run command, 
# fixed issue with old server htop differeing from new server htop output
# Date: 8/12/16: fixed -m comparision
#
##################################################
##################################################
...
function usage
{
    ...
    echo ""
    echo " Output:"
    echo " Name | zID | STATUS | PID | CPU % | MEM | MEM % | Runtime (hrs) | Program"
}
